  ...
  return (
    <div className="w-full">
      <div className="space-y-12">
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-5 text-center md:text-left">Amber Epoxy Garage Floor</h3>
        ...
        {/* Second Before/After Example */}
        <div>
          <h3 className="text-2xl font-semibold mb-5 text-center md:text-left">Gray Speckled Epoxy Garage Floor</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Before image */}
            <div>
              <div className="relative rounded-lg overflow-hidden aspect-[4/3] border shadow-lg">
                ...
                <img 
                  ...
                  alt="Before gray speckled garage floor" 
                  className="object-cover w-full h-full" 
                  loading="lazy" 
                />
              </div>
            ...
            <div>
              <div className="relative rounded-lg overflow-hidden aspect-[4/3] border shadow-lg">
                ...
                <img 
                  ...
                  alt="After gray speckled garage floor" 
                  className="object-cover w-full h-full" 
                  loading="lazy" 
                />
              </div>
