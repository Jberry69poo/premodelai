...
export const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background via-background/90 to-primary/5 pt-24 pb-16 md:pt-32 md:pb-24 px-4">
      {/* Background Elements */}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Button
              ...
              className={`${isMobile ? 'text-base px-5 py-2' : 'text-lg px-8 py-6'} bg-primary text-primary-foreground hover:bg-primary/90 relative overflow-hidden group`}
