...
export const WhatIsPreModel = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-background to-card/30 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl text-muted-foreground mb-6">
              A PreModel is a groundbreaking visualization tool that instantly renders photorealistic images of your customer's space with your epoxy flooring solutions applied.
            </motion.p>
            ...
            <motion.div variants={fadeIn}>
              <Button 
                ...
                className="bg-primary text-primary-foreground text-lg px-8 py-6 rounded-md"
              >
                See How It Works
